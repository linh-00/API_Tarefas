...
app.MapGet("/tarefas/concluida", async (AppDbContext db) =>
                                 await db.Tarefas.Where(t => t.lsConcluida).ToListAsync());
...
app.MapPut("/tarefas/{id}", async (int id, Tarefa inputTarefa, AppDbContext db) =>
{
    ...
    tarefa.lsConcluida = inputTarefa.lsConcluida;
...
app.MapDelete("/tarefas/{id}", async (int id, AppDbContext db) =>
{
    ...
    return Results.NotFound("Id nao encontrada");
});
...
class Tarefa
{
    ...
    public bool lsConcluida {get; set;}
}
